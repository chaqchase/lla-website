---
title: "File Mover"
description: "Clipboard-based interface for moving files and directories"
order: 15
published: true
references: [https://github.com/chaqchase/lla/blob/main/plugins/file_mover]
status: "new"
---
# LLA File Mover Plugin

Clipboard-based moving for files and directories.
...
### 1. Moving Files Between Directories (Explicit Paths)
...
### 2. Moving Files Using Current Directory
