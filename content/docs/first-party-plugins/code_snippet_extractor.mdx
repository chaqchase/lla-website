---
title: "Code Snippet Extractor"
description: "Extract and manage code snippets with tagging and syntax highlighting support"
order: 3
published: true
references: [https://github.com/chaqchase/lla/blob/main/plugins/code_snippet_extractor]
---
# LLA Code Snippet Extractor Plugin

Extract, tag, and manage code snippets.

## Features

- Language detection and contextual extraction
- Categories, tags, metadata
- Fuzzy search and multi-select
- Syntax highlighting and interactive menus
- JSON import/export
