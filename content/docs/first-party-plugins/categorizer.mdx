...
order: 1
published: true
references: [https://github.com/chaqchase/lla/blob/main/plugins/categorizer]
---

# LLA Categorizer Plugin

Categorize files by extension with optional hierarchy.

## Features

- Categorization by extension with colors
- Categories and subcategories
- Size rules and stats
- Configurable categories, colors, rules
