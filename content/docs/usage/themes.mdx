...
order: 6
published: true
references: [https://github.com/triyanox/lla/tree/main/themes]
---
...
- **[default](https://github.com/triyanox/lla/blob/main/themes/default.toml)**: Traditional terminal colors with carefully selected colors for optimal visibility
- **[dark](https://github.com/triyanox/lla/blob/main/themes/dark.toml)**: Modern dark theme with enhanced visibility and rich colors for dark terminals
- **[light](https://github.com/triyanox/lla/blob/main/themes/light.toml)**: Clean theme optimized for light terminals with maximum readability
- **[ayu_dark](https://github.com/triyanox/lla/blob/main/themes/ayu_dark.toml)**: Dark theme inspired by the Ayu Dark color scheme, featuring deep backgrounds and vibrant accents
- **[ayu_light](https://github.com/triyanox/lla/blob/main/themes/ayu_light.toml)**: Light theme with carefully selected colors for optimal readability
- **[ayu_mirage](https://github.com/triyanox/lla/blob/main/themes/ayu_mirage.toml)**: Refined dark theme with muted colors and soft contrasts
- **[catppuccin_mocha](https://github.com/triyanox/lla/blob/main/themes/catppuccin_mocha.toml)**: A soothing pastel theme for the high-spirited, featuring warm, cozy colors
- **[dracula](https://github.com/triyanox/lla/blob/main/themes/dracula.toml)**: Classic Dracula color scheme with vibrant colors and high contrast
- **[gruvbox_dark](https://github.com/triyanox/lla/blob/main/themes/gruvbox_dark.toml)**: Retro groove color scheme with warm, earthy tones and high contrast
- **[material_ocean](https://github.com/triyanox/lla/blob/main/themes/material_ocean.toml)**: Deep blue theme based on Material Design, featuring oceanic colors
- **[nord](https://github.com/triyanox/lla/blob/main/themes/nord.toml)**: Arctic, north-bluish color palette with elegant pastel colors
- **[one_dark](https://github.com/triyanox/lla/blob/main/themes/one_dark.toml)**: Dark theme inspired by Atom, featuring a perfect balance of cool and warm colors
- **[poimandres](https://github.com/triyanox/lla/blob/main/themes/poimandres.toml)**: Deep space aesthetic with vibrant accents
- **[tokyo_night](https://github.com/triyanox/lla/blob/main/themes/tokyo_night.toml)**: Dark theme inspired by the vibrant lights of Tokyo at night
- **[vesper](https://github.com/triyanox/lla/blob/main/themes/vesper.toml)**: Minimalist dark theme with warm accents
