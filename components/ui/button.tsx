...
const buttonStyles = tv({
  base: [
    ...
    'focus:outline-none focus:outline focus:outline-0 focus-visible:outline-2 focus:outline-offset-2 focus:outline-primary-500',
  ...
  variants: {
    ...
    appearance: {
      ...
      plain:
        'border-transparent text-fg [--btn-icon:theme(colors.zinc.500)] active:[--btn-icon:theme(colors.zinc.700)] hover:[--btn-icon:theme(colors.zinc.700)] dark:[--btn-icon:theme(colors.zinc.500)] dark:active:[--btn-icon:theme(colors.zinc.400)] dark:hover:[--btn-icon:theme(colors.zinc.400)]'
    },
