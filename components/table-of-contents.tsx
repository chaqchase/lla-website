...
export function TableOfContents({ className, items }: { className?: string; items: TableOfContentsProps[] }) {
  ...
  return (
    <div className={twJoin('not-prose', className)}>
      <aside className="xl:sticky xl:top-[1.75rem] mb-8 xl:mb-0 p-4 rounded-2xl xl:p-0 xl:rounded-none bg-zinc-100 dark:bg-zinc-900 xl:bg-transparent dark:xl:bg-transparent xl:-mr-6 xl:h-[calc(100vh-4.75rem)] xl:flex-none xl:overflow-y-auto xl:py-16 xl:pr-6">
        <nav aria-labelledby="on-this-page-title" className="w-56">
          ...
          >
            <>
              <Heading level={1} className="text-lg lg:text-xl font-semibold leading-7 mb-6 text-fg">
                On this page
              </Heading>
              {items.length > 0 && (
